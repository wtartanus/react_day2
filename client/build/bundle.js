...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var RegionsSelector = __webpack_require__(160);
	...
	var CountriesBox = React.createClass({
	  ...
	  setCountriesSelector: function setCountriesSelector(region) {
	    console.log(region);
	  ...
	  setBorderCountries: function setBorderCountries(object) {
	    console.log(this);
	  ...
	  render: function render() {
	    ...
	    if (this.state.countriesByRegion.length > 0) {
	      displaySelector = React.createElement(CountrySelector, {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(RegionsSelector, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var CountryInformation = __webpack_require__(163);
	var CountryBorders = __webpack_require__(164);
	...
	var CountryDisplay = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(CountryInformation, { country: this.props.country }),
	      React.createElement(CountryBorders, { countries: this.props.borders })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountryInformation = React.createClass({
	  displayName: 'CountryInformation',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Country = __webpack_require__(165);
	...
	var CountryBorders = React.createClass({
	  ...
	  render: function render() {
	    var borders = this.props.countries.map(function (country) {
	      return React.createElement(Country, { key: country.alpha2Code, name: country.name, capital: country.capital });
	    });
	    return React.createElement(
	      "div",
	      null,
